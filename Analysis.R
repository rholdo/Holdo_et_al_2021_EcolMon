...
# Estimate basal area, tree density and seedling density  along transects from Deus' data
# Recalculate distances along transect using PCA
...
micro <- read.csv('Daily_cleaned_microclimate_data.csv')
